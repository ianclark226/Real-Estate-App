...
const ListingDetails = (props) => {
    ...
    <div className="listingdetail">
            ...
            <div className="listingdetail__header">
                ...
                <p className="listingdetail__location">{listing.ctiy}, {listing.state}, {listing.zipcode}</p>
            </div>
            <div className="row">
            ...
            <div className="row">
                ...
                <div className="listingdetail__display">
                        ...
                        <p className="listingdetail__contact">{realtor.description}</p>
                </div>
            </div>
            <div className="row">
